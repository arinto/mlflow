...
def _run_server(file_store_path, default_artifact_root, host, port, workers, static_prefix, certfile, keyfile):
    """
    ...
    exec_cmd(["gunicorn", "--certfile", certfile, "--keyfile", keyfile, "-b", bind_address, "-w", "%s" % workers, "mlflow.server:app"],
